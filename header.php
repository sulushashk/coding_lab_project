     ...
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          <div class="container-sm">
                    ...
                    <ul class="navbar-nav mx-5 mr-auto mt-2 mt-lg-0 ">
                         ...
                         <li class="nav-item dropdown">
                              ...
                              <ul class="dropdown-menu">
                                   ...
                                   <li><a class="dropdown-item" href="ipad.php">IPad</a></li>
                                   <li><a class="dropdown-item" href="mac.php">Mac</a></li>
                                   <li><a class="dropdown-item" href="airpods.php">AirPods</a></li>
                              </ul>
                         </li>
                         <li class="nav-item">
              ...
              <a class='nav-link' href='profile.php'>Profile Page<span class='sr-only'></span></a>
                              ...
                              echo
                              "<li class='nav-item'>
              <a class='nav-link' href='includes/logout.inc.php'>Log Out<span class='sr-only'></span></a>
         </li>";
                         } else {
                              echo
                              "<li class='nav-item'>
